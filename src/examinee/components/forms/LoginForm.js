...
const LoginFormComponent = () => {
	...
	return (
		<form className="w-full h-1/3 grid gap-y-8"
			onSubmit={handleLoginForm.bind(this)}
		>	
			<div className="h-20 px-60 ">
				<div className="bg-rmit-blue w-full h-full flex items-center">
					<div className=" text-center mx-auto text-2xl text-white">Title of Examination</div>
				</div>
			</div>
            ...
            (errors.hasOwnProperty("username") ? "border-red-500" : "")
					...
					name="username"
					type="tel" pattern="[0-9]{7}"
					placeholder="eg.3822042"
					value={credentials.username}
					onChange={handleInputChange.bind(this)} required
				/>
			...
			<div className=" px-96 w-full">
				<button type="submit" className="bg-rmit-red hover:bg-rmit-red-bold text-white font-bold mx-auto w-full py-2 px-4 rounded focus:border-none">
          Sign in
				</button>
			</div>
		</form>
