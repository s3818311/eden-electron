  ...
  return (
    <ol className="list-decimal text-justify text-2xl">
      ...
      <li>
        ...
        for each question, leaving one half hour to spare. You may allocate your
        time as you wish. I recommend that you spend some time organizing your
        thoughts before you begin to write and that you reserve some time to go
        over your responses after you have completed the exam.
      </li>
    </ol>
  );
}
