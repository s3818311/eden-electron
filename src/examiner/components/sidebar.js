  ...
  return (
    <>
      <div className={`flex flex-col h-screen bg-rmit-blue transition-all ${isOpen ? "w-3/12" : "w-16"}`}>
        ...
        >
          <div className={`flex flex-row items-center text-xl gap-x-5 ${isOpen ? "" : "justify-center"}`}>
            <div className="inline-block"><AiOutlineDashboard size={isOpen ? 30 : 35} className="transition-all"/></div>
            <div className={isOpen ? "inline-block" : "hidden"}>Dashboard</div>
          </div>
        </NavLink>
        <NavLink
          to="/exam"
        ...
        >
          <div className={`flex flex-row items-center text-xl gap-x-5 ${isOpen ? "" : "justify-center"}`}>
            <div className="inline-block"><AiOutlineTable size={isOpen ? 30 : 35} className="transition-all"/></div>
            <div className={isOpen ? "inline-block" : "hidden"}>Exam Manager</div>
          </div>
        </NavLink>
        <NavLink
          to="/student"
        ...
        >
          <div className={`flex flex-row items-center text-xl gap-x-5 ${isOpen ? "" : "justify-center"}`}>
            <div className="inline-block"><AiFillBook size={isOpen ? 30 : 35} className="transition-all"/></div>
            <div className={isOpen ? "inline-block" : "hidden"}>Student Manager</div>
          </div>
        </NavLink>
